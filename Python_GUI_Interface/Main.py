...
def get_entry_fields():
   ...
   text_file.write("cfddatafile=" + "\n")
   text_file.write("cfdmeshfile=" + "\n")
...
def openvtkfile():
    filename = filedialog.askopenfilename(parent=Mafenetre)
    Path_vtk.delete(0, 'end')
    Path_vtk.insert(0,filename)
...
Particle_Number.config(width=5)
...
Label(Mafenetre, text="Evaluation parameters", font='Helvetica 18 bold').grid(row=6, column=0, sticky=W)

Label(Mafenetre, text="Filter type : ").grid(row=7, column=0, sticky=W)
Filter_type = StringVar()
Radiobutton(Mafenetre, text="Gaussian", variable=Filter_type, value="Gaussian").grid(row=8, column = 0, sticky=W)
Radiobutton(Mafenetre, text="Liepmann", variable=Filter_type, value="Liepmann").grid(row=9, column = 0, sticky=W)
Radiobutton(Mafenetre, text="VonKarman", variable=Filter_type, value="VonKarman").grid(row=10, column = 0, sticky=W)

Label(Mafenetre, text="Scaling type : ").grid(row=11, column=0, sticky=W)
Scaling_type = StringVar()
Radiobutton(Mafenetre, text="Particle", variable=Scaling_type, value="particle").grid(row=12, column = 0, sticky=W)
Radiobutton(Mafenetre, text="Grid-Particle", variable=Scaling_type, value="kGrid_lambdaParticle").grid(row=13, column = 0, sticky=W)
Radiobutton(Mafenetre, text="Grid", variable=Scaling_type, value="grid").grid(row=14, column = 0, sticky=W)
Label(Mafenetre, text="Radius of consideration : ").grid(row=15, column=0, sticky=W)
Radius_consideration = Entry(Mafenetre)
Radius_consideration.config(width=2)
Radius_consideration.grid(row=15, column=0, padx = 165)



Label(Mafenetre, text="Windowing parameters", font='Helvetica 18 bold').grid(row=6, column=1, sticky=W)
...
Label(Mafenetre, text="Statistics parameters", font='Helvetica 18 bold').grid(row=6, column=2, sticky=W)
...
#Bouton quitter
Button(Mafenetre, text='Quit', command=Mafenetre.destroy).grid(row=25, column=0, sticky=W)
